...
[Previous](https://ui.shadcn.com/docs/installation/remix) [Next](https://ui.shadcn.com/docs/installation/tanstack)
...
[Use shadcn/create\\
\\
Build your preset and generate an Astro project command.](https://ui.shadcn.com/docs/installation/astro#scaffold-with-create) [Use the CLI\\
\\
Scaffold a new Astro project directly from the terminal.](https://ui.shadcn.com/docs/installation/astro#scaffold-with-cli) [Existing Project\\
\\
Configure shadcn/ui manually in an existing Astro project.](https://ui.shadcn.com/docs/installation/astro#existing-astro-project)

## [Use shadcn/create\#](https://ui.shadcn.com/docs/installation/astro\#use-shadcncreate)

### [Build Your Preset\#](https://ui.shadcn.com/docs/installation/astro\#build-your-preset)

Open [shadcn/create](https://ui.shadcn.com/create?template=astro) and build your preset visually. Choose your style, colors, fonts, icons, and more.

[Open shadcn/create](https://ui.shadcn.com/create?template=astro)
...
## [Use the CLI\#](https://ui.shadcn.com/docs/installation/astro\#use-the-cli)

### [Create Project\#](https://ui.shadcn.com/docs/installation/astro\#create-project-1)
...
### [Add Components\#](https://ui.shadcn.com/docs/installation/astro\#add-components-1)
...
## [Existing Project\#](https://ui.shadcn.com/docs/installation/astro\#existing-project)

### [Create Project\#](https://ui.shadcn.com/docs/installation/astro\#create-project-2)
...
### [Add Components\#](https://ui.shadcn.com/docs/installation/astro\#add-components-2)
...
[Use shadcn/create](https://ui.shadcn.com/docs/installation/astro#use-shadcncreate) [Build Your Preset](https://ui.shadcn.com/docs/installation/astro#build-your-preset) [Create Project](https://ui.shadcn.com/docs/installation/astro#create-project) [Add Components](https://ui.shadcn.com/docs/installation/astro#add-components) [Use the CLI](https://ui.shadcn.com/docs/installation/astro#use-the-cli) [Create Project](https://ui.shadcn.com/docs/installation/astro#create-project-1) [Add Components](https://ui.shadcn.com/docs/installation/astro#add-components-1) [Existing Project](https://ui.shadcn.com/docs/installation/astro#existing-project) [Create Project](https://ui.shadcn.com/docs/installation/astro#create-project-2) [Edit tsconfig.json file](https://ui.shadcn.com/docs/installation/astro#edit-tsconfigjson-file) [Run the CLI](https://ui.shadcn.com/docs/installation/astro#run-the-cli) [Add Components](https://ui.shadcn.com/docs/installation/astro#add-components-2)
